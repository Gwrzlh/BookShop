                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" name="nama_kategori" id="nama_kategori" placeholder="Masukkan kategori"
                            class="block w-full rounded-md border-gray-300 py-2 px-3 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ $kategori->nama_Kategori }}">
                    </div>
                </div>
